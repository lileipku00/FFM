...
if plot_ev:
    ...
    for i in range(len(selected_events)):
        try:
            ...
            m.drawgreatcircle(float(evnt[2]), float(evnt[1]), center_lon, center_lat, c='r', linewidth=6)
    ...
    m.drawgreatcircle(event_lon_gc, event_lat_gc, center_lon, center_lat, linewidth=6, c='b')
