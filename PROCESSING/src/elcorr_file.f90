...
IF (ios<0) THEN
WRITE(*,*) 'Reached to the end of the file', datar
EXIT
END IF
...
WRITE(4,fmt=44) del,sdep,slat,az,tt,tt+tcor,tcor
44 format(f10.6,',',f10.5,',',f10.6,',',f10.6,',',f10.6,',',f10.6,',',f10.6)
